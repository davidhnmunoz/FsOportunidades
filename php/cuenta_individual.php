...
$cuentas = $conexion->prepare('SELECT cue.id , con.nombre as "nombrecontacto", con.apellido as "apellidocontacto",cue.nombreempresa  ,cue.telefono,cue.sitioweb,cue.cuit,cue.descripcion, cue.telefono, emp.nombre, emp.apellido, dir.CodPostal, prov.nombre as "provincia" ,
