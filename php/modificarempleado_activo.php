...
/*UPDATE tabla Empleados*/
    $sql       = "UPDATE empleados SET nombre=:nombre , apellido=:apellido ,cargo=:cargo, fechanacimiento=:fechanacimiento,telmovil=:telmovil , interno=:interno, notas=:notas,usuario_id=:usuario_id,jefe_id=:jefe_idm, direccion_id=:direccion_id  WHERE id=:idUsu";
