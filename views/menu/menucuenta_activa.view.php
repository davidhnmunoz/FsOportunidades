    ...
    <a class="nav-link" href="../index.php">HOME</a>
                        ...
                        <div class="collapse navbar-collapse">
                            ...
                            <li class="nav-item">
                                    ...
                                    <a class="nav-link active" href="../php/index_cuenta.php">
                                        Cuentas
                                    </a>
                    ...
                    <li class="nav-item ">
                        ...
                        <form class="form-inline my-2 my-lg-0">
                            <div class="input-group-addon">
                                <a href="../php/busqueda_cuenta_activa.ajax.php">
                                    <i aria-hidden="true" class="fa fa-search fa-lg">
                                    </i>
                                </a>
                            </div>
                            <a class="btn btn-primary" href="../php/busqueda_cuenta_activa.ajax.php" name="buscar">
                                Buscar Cuenta
                            </a>
                        </form>
                    </li>
